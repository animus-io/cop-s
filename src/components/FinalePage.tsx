...
export function FinalePage({ onNavigate }: FinalePageProps) {
  ...
  const events = [
    ...
    },
    {
      ...
      description:
        "Official unveiling of the unified youth climate declaration",
      icon: Award,
    },
    {
      time: "2:00 PM",
  ...
  const highlights = [
    {
      ...
      description:
        "Regional chapters present their policy recommendations to government officials and climate experts",
      image:
        "https://images.unsplash.com/photo-1570210661710-e5549821e248?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHx5b3V0aCUyMGNsaW1hdGUlMjBhY3Rpb258ZW58MXx8fHwxNzU5NDk3ODUxfDA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral",
    },
    {
      title: "Climate Action Declaration",
      description:
        "Launch of a unified document outlining youth climate priorities and demands for 2025",
      image:
        "https://images.unsplash.com/photo-1758270703662-b7d58bf0a8a2?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxkaXZlcnNlJTIweW91bmclMjBwZW9wbGV8ZW58MXx8fHwxNzU5NDk3ODUyfDA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral",
    },
    {
      title: "Artivism Exhibition",
      description:
        "Showcase of creative advocacy projects including art, videos, and performances",
      image:
        "https://images.unsplash.com/photo-1757356892992-d8e5ceb4429d?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxlbnZpcm9ubWVudCUyMHN1c3RhaW5hYmlsaXR5fGVufDF8fHx8MTc1OTQxNjg1N3ww&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral",
    },
  ];
    ...
    <div className="pt-8">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-700 mb-8 max-w-3xl mx-auto">
              The culmination of 12 weeks of learning, simulation, and advocacy
              - where young climate leaders from across Pakistan unite to
              present their vision for climate action.
            </p>
          ...
          <div className="relative rounded-2xl overflow-hidden shadow-2xl">
            <ImageWithFallback
              src="/assets/islamabad/islamabad.webp"
            ...
            <div className="absolute bottom-8 left-8 text-white">
              <h3 className="text-2xl font-bold mb-2">
                A Platform for Youth Climate Leadership
              </h3>
              <p className="text-lg">
                Where policies meet passion and voices become action
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8">
            ...
            <p className="text-lg text-gray-600">
              Don't miss this historic gathering of young climate leaders
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-2xl mx-auto">
            ...
            <Card className="text-center shadow-lg hover:shadow-xl transition-shadow duration-300">
              <CardContent className="p-6">
                <div className="text-3xl font-bold text-coral-orange mb-2">
                  {timeLeft.minutes}
                </div>
            ...
            <Card className="text-center shadow-lg hover:shadow-xl transition-shadow duration-300">
              <CardContent className="p-6">
                <div className="text-3xl font-bold text-creative-purple mb-2">
                  {timeLeft.seconds}
                </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8">
            ...
            <p className="text-lg text-gray-700 mb-6">
              A unified voice from Pakistan's youth outlining climate
              priorities, policy recommendations, and commitments for
              sustainable action.
            </p>
          </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
            <Card>
              <CardContent className="p-6">
                ...
                <p className="text-gray-600">
                  Visual documentation of the 12-week journey across all
                  regional chapters
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardContent className="p-6">
                ...
                <p className="text-gray-600">
                  Interactive display of climate solutions and artivism projects
            ...
            <Card>
              <CardContent className="p-6">
                ...
                <p className="text-gray-600">
                  Space for participants to connect, share experiences, and plan
          ...
          <div className="text-center">
            <p className="text-lg text-gray-700 mb-6">
              The finale will be livestreamed for families and supporters who
      ...
      <section className="py-16 relative overflow-hidden bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl mb-8 text-green-800">
            The finale represents not just an ending, but the beginning of a
            lifelong commitment to climate action. Join us in Islamabad for this
            historic moment.
          </p>
