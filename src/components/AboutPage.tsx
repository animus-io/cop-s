...
export function AboutPage({ onNavigate }: AboutPageProps) {
  const timeline = [
    ...
    },
    {
      ...
      description:
        "Expanding to 5 cities with 500+ participants and enhanced curriculum",
      status: "current",
    },
    {
      id: "recognition-2025",
  ...
  const partners = [
    {
      ...
      description:
        "Global leader in child rights and protection, bringing safeguarding expertise and youth engagement frameworks.",
      logo: "STC",
    },
    {
  ...
  const values = [
    {
      ...
      title: "Youth-Led",
      description:
        "Empowering young people to lead climate action and policy discussions",
    ...
    },
    {
      ...
      title: "Inclusive",
      description:
        "Welcoming participants from all backgrounds, regions, and communities",
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              ...
              <p className="text-lg text-gray-700 leading-relaxed">
                COP Simulation Pakistan 2025 is the country's largest youth-led
                climate action program, designed to educate, engage, and empower
                young people to become effective climate advocates and policy
                influencers.
              </p>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <Card className="p-8 border-l-4 border-l-green-500">
              <CardContent className="p-0">
                ...
                <p className="text-lg text-gray-700 leading-relaxed">
                  A Pakistan where young people are at the forefront of climate
                  action, equipped with the knowledge, skills, and platforms to
                  drive meaningful environmental change and influence policy
            ...
            <Card className="p-8 border-l-4 border-l-blue-500">
              <CardContent className="p-0">
                ...
                <p className="text-lg text-gray-700 leading-relaxed">
                  To provide Pakistani youth with comprehensive climate
                  education, hands-on simulation experiences, and advocacy
                  skills training that enables them to effectively participate
                  in climate governance and drive sustainable development in
                  their communities.
                </p>
              </CardContent>
            </Card>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              The principles that guide our approach to youth climate education
              and engagement
            </p>
          </div>
            ...
            {values.map((value) => {
              ...
              return (
                ...
                >
                  <CardContent className="p-0">
                    <div
                      className={`w-16 h-16 rounded-full ${value.color} mx-auto mb-4 flex items-center justify-center`}
                    >
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      500+ young climate leaders equipped with negotiation and
                      advocacy skills
                    </p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Youth-led policy recommendations presented to government
                      stakeholders
                    </p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Local climate action projects launched in participating
                      communities
                    </p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Sustainable youth climate network established across
                      Pakistan
                    </p>
                  </div>
                </div>
